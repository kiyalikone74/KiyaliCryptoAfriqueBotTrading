...
# ------------------------------
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "")             # <-- remplace ici
    ...
    try:
        ...
        if not reply:
            reply = ("Salut 👋 Je suis CryptoAfricoBotTrading.\n"
                     "En savoir plus sur: 'comment recevoir les signaux', 'c'est quoi le copy trading', 'est ce gratuit',\n"
...
@app.route('/')
def home():
    return "CryptoAfriqueBotTrading is alive!"
